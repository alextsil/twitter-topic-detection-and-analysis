...
\begin{figure*}[h!]
	...
	\centering
	\caption{System performance when varying the gazetteer used to identify self-reported locations\cite{jurgens2015geolocation}.}
	\label{fig:reported}
\end{figure*}
\par 
...
\begin{figure}[h!]
	...
	\caption{Performance during cross-validation of the training
		...
		ground truth\cite{jurgens2015geolocation}.}
	\label{fig:cross}
\end{figure}
